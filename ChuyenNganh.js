...
class ChuyenNganh extends React.Component {
  ...
  static navigationOptions = {
    title: 'Chuyên Ngành CNTT',
  };

  componentDidMount() {
    return fetch('https://nvtrung96.000webhostapp.com/select_truyenngan.php')
...
const AppChuyenNganh =createStackNavigator({
  ChuyenNganh:{
    screen:ChuyenNganh
  },
  ChiTiet:{
...
export default createAppContainer(AppChuyenNganh);
